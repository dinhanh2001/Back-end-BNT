 ...
 *               type:
 *                 type: string
 *                 description: books type (car, var, bike, etc...)
 *               manufacturer:
 *                 type: string
 *               model:
 *                 type: string
 *                 description: books model (308, Demio, Aqua, etc...)
 *               numberplate:
 *                  type: string
 *               makeyear:
 *                  type: string
 ...
 *           minimum: 1
 *         default: 10
 *         description: Maximum number of bookss
 *       - in: query
 *         name: page
 *         schema:
 *           type: integer
 ...
 *   get:
 *     summary: Get a books
 *     description: fetch Bookss by id
 *     tags: [Bookss]
 *     security:
 *       - bearerAuth: []
 *     parameters:
